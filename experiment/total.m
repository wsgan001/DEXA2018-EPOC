...
%     cover201 = sum(predictlabel1(index_cover(end-19:end)))/20 ;
%     predictmetric1(1:8,epoch) = [TP;FP;FN;TN;recall1; precision1; f11; cover201] ;
...
% fprintf('SVR classification finish.\n')
% %% Linear classification
% baseline2 = fitlm(X(1:cas_num*Train,1:3),X(1:cas_num*Train,4));
% predict_count2 = predict(baseline2,X(cas_num*Train+1:end,1:3));
% predictlabel2 = (predict_count2>=threshold);
% %precision = 1-sum(abs(predictlabel-index(:,4)))/cas_num ;
